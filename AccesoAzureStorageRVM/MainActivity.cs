...
namespace AccesoAzureStorageRVM
{
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            btnAlmacenar.Click += async delegate
            {
                try
                {
                    ...
                    Toast.MakeText(this, "Imagen Almacenada en contenedor de blobs en Azure",
                        ToastLength.Long).Show();
                    ...
                    Toast.MakeText(this, "Datos guardados en tabla NoSQL en Azure",
                        ToastLength.Long).Show();
